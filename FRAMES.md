...
|------|---------|-----|------|-------------|---------|-------------|
| `A1` | 21→D5 | 24 | Commande (mode/fan/consigne/swing/config/beep) | b12 mode+fan+power · b13 consigne−16 · b14 swing · b15 config word · b16 beep? · b16-21 MAC | `7A7A21D518…+CRC` | `forge_payload` |
...
| Type | src→dst | Len | Rôle | Champs clés | Exemple | Statut code |
|------|---------|-----|------|-------------|---------|-------------|
| `A3` | D5→21 | 34 | Feedback complet de l'AC | b10-11 temp sonde · b13 mode(0-2)+on/off(3)+fan(4-6) · b14 consigne (nibble bas +16) · b15 swing · **b16 config word** · b19-20 timer · b23-24 heures | `7A7AD521220000A30A0A1700005909008800000000016477FC44423131333730E8D8` | `publish_feedback` + réconciliation A3-diff |
